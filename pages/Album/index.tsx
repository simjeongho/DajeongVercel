...
import useGetSingleAlbumList, { getSingleAlbumList } from "hooks/useGetSingleAlbumList";
...
export const getServerSideProps: GetServerSideProps = async (context) => {
	...
	await queryClient.prefetchQuery("getSingleAlbumList", () => getSingleAlbumList);
					...
					<AxiosSlider title="Single Albums">
						{data?.data.singleAlbumList.map((postitem) => (
							<LinkCard
								...
								src={`${API_HOST}/${postitem.filePath}`}
